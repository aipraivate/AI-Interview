...
依据《AI面试辅助平台 — 商业级产品需求与技术规格说明书 V2.0 完善版》实现的 C 端 P0 可交付版本，并补充了“驾考宝典式”面试训练中心。用户可从分类题库、顺序/随机/专项练习、错题本、收藏和模拟考试进入，也可继续使用简历 + JD 驱动的 AI 文字面试、证据式复盘、权益与数据权利闭环。
...
- `/api/v1/practice/*`：训练看板、分类题库、顺序/随机/专项/模考、错题、收藏和成绩分享
- `/api/v1/shares/*`：带有效期的公开训练成绩页，不暴露用户身份和答题明细
